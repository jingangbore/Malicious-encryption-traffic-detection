...
def read_res2(path, file_name):
    ...
    with open(path + file_name) as f:
        for line in f:
            ...
            index += 1
    f.close()
    print("number of lines:", str(index))
    return data, labels
...
def get_data_from_file(path, file_name):
    ...
    with open(path + file_name) as f:
        ...
        for line in f:
            ...
            temp = list(map(float, literal_eval(line)))
            #print(temp)
            features = [
                        temp[0],
                        temp[1],
...
def get_all_data(path_to_folder):
    X_train = get_data_from_file(path_to_folder, "X_train_46.txt")
    X_test = get_data_from_file(path_to_folder, "X_test_46.txt")
    Y_train = get_labels_from_file(path_to_folder, "Y_train_46.txt")
    Y_test = get_labels_from_file(path_to_folder, "Y_test_46.txt")
